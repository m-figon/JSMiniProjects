...
const checkIfPossible = (y, x, player) => {
    if (board[y + 1][x + 1] === 'W' && player === 'W' && (board[y][x] === ' ' || (board[y][x] === 'B' && board[y - 1][x - 1] === ' '))){
        board[y+1][x+1]=' ';
        return true;
    }else if(board[y + 1][x - 1] === 'W' && player === 'W' && (board[y][x] === ' ' || (board[y][x] === 'B' && board[y - 1][x + 1] === ' '))){
        board[y+1][x-1]=' ';
        return true;
    }else if(board[y - 1][x + 1] === 'B' && player === 'B' && (board[y][x] === ' ' || (board[y][x] === 'W' && board[y + 1][x - 1] === ' '))){
        board[y-1][x+1]=' ';
        return true;
    }else if(board[y - 1][x - 1] === 'B' && player === 'B' && (board[y][x] === ' ' || (board[y][x] === 'W' && board[y + 1][x + 1] === ' '))){
        board[y-1][x-1]=' ';
